...
Gem::Specification.new do |s|
  ...
  s.files = ["DEPLOYMENT.md", "History.txt", "Manifest.txt", "README.md", "bin/puma", "bin/pumactl", "docs/nginx.md", "docs/signals.md", "docs/systemd.md", "tools/jungle/README.md", "tools/jungle/init.d/README.md", "tools/jungle/upstart/README.md"]
