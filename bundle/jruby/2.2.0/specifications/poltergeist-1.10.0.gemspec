# -*- encoding: utf-8 -*-
# stub: poltergeist 1.10.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<pdf-reader>, [">= 1.3.3", "~> 1.3"])
      s.add_development_dependency(%q<coffee-script>, ["~> 2.2"])
      s.add_development_dependency(%q<guard-coffeescript>, ["~> 2.0.0"])
      s.add_development_dependency(%q<coffee-script-source>, ["~> 1.10.0"])
      s.add_development_dependency(%q<listen>, ["~> 3.0.6"])
      ...
      s.add_dependency(%q<pdf-reader>, [">= 1.3.3", "~> 1.3"])
      s.add_dependency(%q<coffee-script>, ["~> 2.2"])
      s.add_dependency(%q<guard-coffeescript>, ["~> 2.0.0"])
      s.add_dependency(%q<coffee-script-source>, ["~> 1.10.0"])
