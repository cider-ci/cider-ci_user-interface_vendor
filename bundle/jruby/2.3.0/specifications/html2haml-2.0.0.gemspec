...
Gem::Specification.new do |s|
  ...
  s.authors = ["Norman Clarke".freeze, "Stefan Natchev".freeze]
  s.date = "2015-01-19"
  s.description = "Converts HTML into Haml".freeze
  s.email = ["norman@njclarke.com".freeze, "stefan.natchev@gmail.com".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<haml>.freeze, ["~> 4.0.0"])
