...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec-core>.freeze, ["!= 3.4.0"])
      ...
      s.add_development_dependency(%q<coffee-script-source>.freeze, ["~> 1.10.0"])
      ...
      s.add_dependency(%q<coffee-script-source>.freeze, ["~> 1.10.0"])
