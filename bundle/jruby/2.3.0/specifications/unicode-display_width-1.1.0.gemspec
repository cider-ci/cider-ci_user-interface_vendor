# -*- encoding: utf-8 -*-
# stub: unicode-display_width 1.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2016-06-22"
  s.description = "[Unicode 1.1.0] Determines the monospace display width of a string using EastAsianWidth.txt, Unicode general category, and other data.".freeze
