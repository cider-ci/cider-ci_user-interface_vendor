# -*- encoding: utf-8 -*-
# stub: jar-dependencies 0.3.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "Mavenfile", "Rakefile", "Readme.md", "bin/lock_jars", "jar-dependencies.gemspec", "lib/jar-dependencies.rb", "lib/jar_dependencies.rb", "lib/jar_install_post_install_hook.rb", "lib/jar_installer.rb", "lib/jars/attach_jars_pom.rb", "lib/jars/classpath.rb", "lib/jars/gemspec_artifacts.rb", "lib/jars/gemspec_pom.rb", "lib/jars/installer.rb", "lib/jars/lock.rb", "lib/jars/lock_down.rb", "lib/jars/lock_down_pom.rb", "lib/jars/maven_exec.rb", "lib/jars/maven_factory.rb", "lib/jars/output_jars_pom.rb", "lib/jars/post_install_hook.rb", "lib/jars/setup.rb", "lib/jars/version.rb", "lib/rubygems_plugin.rb"]
